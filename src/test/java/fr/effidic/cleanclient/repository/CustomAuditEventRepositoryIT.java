...
import fr.effidic.cleanclient.config.audit.AuditEventConverter;
import fr.effidic.cleanclient.domain.PersistentAuditEvent;
...
import static fr.effidic.cleanclient.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
